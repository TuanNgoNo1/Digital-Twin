...
public static class SceneAuthoredWiringBoardSetup
{
    ...
    private static readonly Dictionary<string, Vector2> SocketPixels =
        new Dictionary<string, Vector2>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            { "X4", new Vector2(137f, 412f) }, { "X3", new Vector2(137f, 478.5f) },
            { "X2", new Vector2(137f, 544.5f) }, { "X1", new Vector2(137f, 608f) },
            { "X0", new Vector2(137f, 672f) }, { "SS", new Vector2(137f, 734.5f) },
            { "Y4", new Vector2(409f, 418.5f) }, { "Y3", new Vector2(409f, 486f) },
            { "Y2", new Vector2(408.5f, 554f) }, { "Y1", new Vector2(409f, 625f) },
            { "Y0", new Vector2(408.5f, 698.5f) }, { "+V4", new Vector2(537.5f, 427f) },
            { "+V3", new Vector2(537.5f, 502f) }, { "+V2", new Vector2(537.5f, 578.5f) },
            { "+V1", new Vector2(537f, 654.5f) }, { "+V0", new Vector2(538f, 733f) },
            ...
            { "Pin13", new Vector2(678f, 729f) }, { "Pin14", new Vector2(678f, 785.5f) },
            { "oA", new Vector2(863.5f, 377f) }, { "oB", new Vector2(865.5f, 458.5f) },
            { "oC", new Vector2(865.5f, 535f) }, { "Motor_A", new Vector2(1088f, 560f) },
            { "Motor_B", new Vector2(1088f, 621f) }, { "Motor_C", new Vector2(1087.5f, 681.5f) },
            { "Enc_A", new Vector2(1128f, 805.5f) }, { "Enc_B", new Vector2(1128f, 884f) }
        };
    ...
    public static void Build()
    {
        ...
        foreach (SocketPoint socket in sockets.OrderBy(value => value.socketID, StringComparer.OrdinalIgnoreCase))
        {
            ...
            Vector3 wiringPosition = center + right * (horizontal * width) + up * (vertical * height) + normal * 0.01f;
        ...
        foreach (KeyValuePair<string, Vector2> entry in SocketPixels)
        {
            ...
            Vector3 position = center + right * (horizontal * width) + up * (vertical * height) + normal * 0.012f;
    ...
    private static void CreateJackVisual(SocketPoint socket, Transform parent, Camera camera)
    {
        ...
        visual.transform.SetPositionAndRotation(socket.transform.position, camera.transform.rotation * Quaternion.Euler(0f, 180f, 0f));
