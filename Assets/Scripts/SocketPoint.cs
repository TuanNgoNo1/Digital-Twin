...
public class SocketPoint : MonoBehaviour
{
    ...
    // Jack visual is 14 px in diameter; an 18 px focus ring leaves a small,
    // readable gap without covering neighbouring labels.
    private const float GuideFocusRingRadiusPixels = 9f;
