...
# Bai 1 uses COM3 for the HTTP gateway, PlcBridge and GX Works2 alike. Mode
# switching must release this port before GX Works2 goes online. COM5 remains
# dedicated to Bai 2 telemetry; COM8 is reserved for other practical lessons.
...
$env:FXPLC_ENCODER_PULSES_PER_REV = "5000"
